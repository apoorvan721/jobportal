            ...
            <form action="controller/seeker_register.php" method="post" class="p-4 border rounded"
              ...
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="city" class="form-control" placeholder="City" id="city" name="city" required>
                </div>
              </div>
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="resume">Upload Resume</label>
                  <label class="btn btn-primary btn-md btn-file">Browse File<input type="file" id="resume" name="resume"
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <button name="sregister" type="submit" value="Sign Up" class="btn px-4 btn-primary text-white">Sign
                    Up</button>
                </div>
              </div>
              <div class="row form-group">
